    ...
    <header className="sticky top-0 z-40 border-b bg-white/90 backdrop-blur-xl">
      <div className="page-shell flex h-18 items-center justify-between gap-5">
        ...
        <nav className="hidden items-center gap-7 text-sm font-semibold text-muted-foreground md:flex" aria-label="Основная навигация">
          <Link href="/projects" className="transition hover:text-green-700">Проекты</Link>
          <Link href="/#advantages" className="transition hover:text-green-700">Возможности</Link>
          <Link href="/#about" className="transition hover:text-green-700">О платформе</Link>
        </nav>
