  ...
  return (
    <footer className="border-t bg-primary py-12 text-primary-foreground">
      <div className="page-shell grid gap-10 md:grid-cols-[1.5fr_1fr_1fr]">
        <div><Logo className="text-primary-foreground [&_span:first-child]:border [&_span:first-child]:border-primary-foreground [&_span:first-child]:bg-accent [&_span:first-child]:text-accent-foreground" /><p className="mt-4 max-w-sm text-sm leading-6 text-primary-foreground">Единая цифровая платформа, где добрые дела становятся заметными, подтверждёнными и доступными каждому.</p></div>
