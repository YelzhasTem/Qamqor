        ...
        <div className="page-shell grid items-center gap-14 lg:grid-cols-[1.04fr_.96fr]">
          ...
          <div className="relative mx-auto w-full max-w-xl">
            ...
            <div className="glass-card relative rounded-[2rem] border border-surface p-4 sm:p-6">
              ...
              <div className="mt-4 rounded-2xl bg-primary p-5 text-primary-foreground"><div className="flex items-end justify-between"><div><p className="text-xs text-primary-foreground">До новой награды</p><p className="mt-1 font-bold">Опора сообщества</p></div><span className="text-sm font-black">48 / 50 ч</span></div><div className="mt-3 h-2 overflow-hidden rounded-full bg-primary-foreground/15"><div className="h-full w-[96%] rounded-full bg-primary-foreground" /></div></div>
            </div>
